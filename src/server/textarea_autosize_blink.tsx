        ...
        res.send(
            "<!DOCTYPE html>" + renderToString(
                ...
                <body style={{margin: 10}}>
                    <script crossOrigin="true" src="https://unpkg.com/react@16.13.1/umd/react.production.min.js"></script>
                    <script crossOrigin="true" src="https://unpkg.com/react-dom@16.13.1/umd/react-dom.production.min.js"></script>
                    <script crossOrigin="true" src="https://unpkg.com/react-bootstrap@1.0.1/dist/react-bootstrap.min.js"> </script>
